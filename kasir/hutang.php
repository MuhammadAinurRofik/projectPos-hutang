              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-warning btn-sm" href="hutang_edit.php?id=<?php echo $d['hutang_id'] ?>"><i class="fa fa-cog"></i></a>
                      ...
                      <div class="modal fade" id="hapus_hutang_<?php echo $d['hutang_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Yakin ingin menghapus hutang ini?</p>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                              <a class="btn btn-danger btn-sm" href="hutang_hapus.php?id=<?php echo $d['hutang_id'] ?>"><i class="fa fa-check"></i> Ya, Hapus</a>
                            </div>
                          </div>
                        </div>
                      </div>
