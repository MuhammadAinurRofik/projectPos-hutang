                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td width="20%" class="text-center">
                                          <?php 
                                          // Periksa apakah kunci 'produk_harga_grosir' ada sebelum mencoba mengaksesnya
                                          if(isset($d['produk_harga_grosir'])) {
                                              echo "Rp.".number_format($d['produk_harga_grosir']).",-";
                                          } else {
                                              echo "Harga grosir tidak tersedia";
                                          }
                                          ?>
                                      </td>
                                      ...
                                      <td width="1%">            
                                          ...
                                          ?>          
                                              ...
                                              <input type="hidden" id="harga_<?php echo $d['produk_id']; ?>" value="<?php echo $d['produk_harga_grosir']; ?>">
